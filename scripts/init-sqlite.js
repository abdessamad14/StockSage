...
try {
  ...
  try {
    ...
    const requiredColumns = [
      { name: 'printer_type', sql: 'ALTER TABLE settings ADD COLUMN printer_type TEXT DEFAULT "none"' },
      { name: 'printer_address', sql: 'ALTER TABLE settings ADD COLUMN printer_address TEXT' },
