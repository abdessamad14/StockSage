...
const frTranslations: TranslationDictionary = {
  ...
  'margin': 'Marge',
  'optional': 'optionnel',
  'pack_pricing': 'Prix par pack',
  'pack_pricing_description': 'Définissez un prix spécial pour les ventes en pack (ex: pack de 6, pack de 30)',
  'pack_size': 'Unités par pack',
  'pack_price': 'Prix du pack',
  'pack_barcode': 'Code-barres du pack',
  'unit_price_in_pack': 'Prix unitaire dans le pack',
  'savings_per_unit': 'Économie par unité',
  'select_sale_type': 'Choisir le mode de vente',
  'sell_by_unit': 'Vendre à l\'unité',
  'sell_by_pack': 'Vendre en pack',
  'units': 'unités',
  'offline_pos_receipt_ready_to_print': 'Vente terminée. Cliquez sur "Imprimer le reçu" pour imprimer.',
...
const arTranslations: TranslationDictionary = {
  ...
  'margin': 'هامش الربح',
  'optional': 'اختياري',
  'pack_pricing': 'سعر الحزمة',
  'pack_pricing_description': 'حدد سعرًا خاصًا للمبيعات بالحزمة (مثال: حزمة 6، حزمة 30)',
  'pack_size': 'عدد الوحدات في الحزمة',
  'pack_price': 'سعر الحزمة',
  'pack_barcode': 'باركود الحزمة',
  'unit_price_in_pack': 'سعر الوحدة في الحزمة',
  'savings_per_unit': 'التوفير لكل وحدة',
  'select_sale_type': 'اختر نوع البيع',
  'sell_by_unit': 'بيع بالوحدة',
  'sell_by_pack': 'بيع بالحزمة',
  'units': 'وحدات',
  'offline_pos_receipt_ready_to_print': 'تم إتمام البيع. انقر على "طباعة الإيصال" للطباعة.',
